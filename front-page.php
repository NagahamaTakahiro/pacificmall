...
<section class="section-contents" id="shop">
  <div class="wrapper">
    ...
    <ul class="shops">
      ...
      ?>
          <li class="shops-item">
            <a class="shop-link" href="<?php get_the_permalink(); ?>">
    ...
    <div class="articles">
      ...
      ?>
          <article class="article-card">
            <a class="card-link" href="<?php get_the_permalink(); ?>">
...
<section class="section-contents" id="news">
  <div class="wrapper">
    ...
    <p class="section-lead"><?php echo $term_obj->discription; ?></p>
    <ul class="news">
      <?php
      ...
      ?>
          <li class="news-item">
            <a class="detail-link" href="<?php get_the_permalink(); ?>">
              <time class="time"><?php get_the_time('Y.m.d'); ?></time>
